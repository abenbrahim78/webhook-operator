...
# middleware.operator.com/middleware-operator-bundle:$VERSION and middleware.operator.com/middleware-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= middleware.operator.com/middleware-operator
